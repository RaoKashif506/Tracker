...
profileRouter.get("/", requireAuth, async (req, res) => {
    try {
        ...
        return sendError(res, "PROFILE_ERROR", error.message, 404);
    }
});
profileRouter.patch("/", requireAuth, async (req, res) => {
    ...
    try {
        ...
        return sendError(res, "PROFILE_ERROR", error.message, 400);
    }
});
profileRouter.post("/change-password", requireAuth, async (req, res) => {
...
profileRouter.delete("/", requireAuth, async (req, res) => {
