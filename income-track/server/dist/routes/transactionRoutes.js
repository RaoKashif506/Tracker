...
transactionRouter.get("/:id", requireAuth, async (req, res) => {
...
transactionRouter.patch("/:id", requireAuth, async (req, res) => {
...
transactionRouter.delete("/:id", requireAuth, async (req, res) => {
